# Enterprise Cyber Lab — preserved V1 overview

Historical Windows/VirtualBox documentation. Current work continues in [Enterprise Cyber Lab V2](ENTERPRISE_CYBER_LAB_V2.md); the architecture and verified outcomes below describe V1.
...
- [Recruiter-facing case study](PORTFOLIO_CASE_STUDY.md)
- [Core network validation record](core-network-validation-2026-08-27.md)
...
Detailed evidence: [Core Network Validation Record](core-network-validation-2026-08-27.md)
